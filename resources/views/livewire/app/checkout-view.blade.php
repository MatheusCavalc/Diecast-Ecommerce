<div>
    @if ($cartBox)
        <div class="grid grid-cols-3 py-5">
            <div class="lg:col-span-2 col-span-3 bg-gray-50 space-y-8 px-4 md:px-40 py-10 md:order-1 order-2">
            ...
            <div class="col-span-3 md:col-span-1 bg-white lg:block md:order-2 order-1">
    ...
    @else
        <div class="flex justify-center my-20 md:my-40">
            <p class="text-2xl md:text-3xl">Cart Empty</p>
        </div>
    @endif
</div>
